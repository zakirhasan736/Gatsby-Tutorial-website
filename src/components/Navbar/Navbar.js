...
<li key={id} className="NavItem">
  ...
  <a href="#login" className="NavItem-loginBtn">登录</a>
        ...
        <a href="/lang" className="NavItem-loginBtn Lng-Btn">EN</a>
      </div>
       ...
       <GiHamburgerMenu color="#fff" fontSize={27} onClick={() => setToggleMenu(true)} />
        ...
        {toggleMenu && (
          <div className="app__navbar-smallscreen_overlay flex__center">
             <div className="app__navbar__smallscreenAnima  slide-left">
             <div className="app__navbar-logo">
     <a href='/' >
     <img src={images.logo} alt='logo' />
     </a>
...
<div className="app__navbar-login moboView">
        <a href="#login" className="NavItem-loginBtn">登录</a>
        <a href="/" className="NavItem-signUpBtn">注册</a>
        <a href="/lang" className="NavItem-loginBtn Lng-Btn">EN</a>
      </div>

      <ul className="app__navbar-smallscreen_links bottom-Nav">
